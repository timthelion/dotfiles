...
--
myWorkspaces    = withScreens 3 $ map show [1..8]
 
...
 
    ...
    --, ((0                 , xK_F22), lowerVolume 10 >> return ())
    --, ((0                 , xK_F23), raiseVolume 10 >> return ())
     
...
 
    ...
    , ((modm              , xK_x     ), promptWSGroupAdd oxyXPConfig "Add group: ")
    , ((modm              , xK_c     ), promptWSGroupView oxyXPConfig "Switch to group: ")
    ]
    ++
 
    --
...
--
myLayout = avoidStruts (tiled ||| Mirror tiled ||| Full) ||| Accordion ||| Full |||Roledex
  where
